 ...
 //public members
    ...
    var blockHasher = (function () {
        switch (options.coin.algorithm) {
            ...
            case 'sha256tx':
                return function (d) {
                    return util.reverseBuffer(util.sha256tx(d));
                };
            default:
                return function () {
                    return util.reverseBuffer(hashDigest.apply(this, arguments));
    ...
    this.processShare = function(jobId, previousDifficulty, difficulty, extraNonce1, extraNonce2, nTime, nonce, ipAddress, port, workerName){
        ...
        //@wynn
        //console.log("conbase hex : %s",coinbaseBuffer.toString('hex'));
        //console.log("conbase hash: %s",coinbaseHash.toString('hex'));
        //console.log("header  hex : %s",headerBuffer.toString('hex'));
        //console.log("header hashA: %s",headerHash.toString('hex'));
        //console.log("header hashB: %s",headerBigNum.toString(16));
