...
var pool = module.exports = function pool(options, authorizeFn){
    ...
    function DetectCoinData(finishedCallback){
        ...
        _this.daemon.batchCmd(batchRpcCalls, function(error, results){
            ...
            if (options.coin.reward === 'POS' && typeof(rpcResults.getaddressinfo.pubkey) == 'undefined') {
            ...
            options.poolAddressScript = (function(){
                switch(options.coin.reward){
                    ...
                    case 'POW':
                        //@wynn
                        return util.addressToScript(rpcResults.getaddressinfo.address);
            ...
            options.initStats = {
                ...
                difficulty: rpcResults.getmininginfo['proof-of-work'] * algos[options.coin.algorithm].multiplier,
                //
